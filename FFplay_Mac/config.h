...
#define FFMPEG_CONFIGURATION "--logfile=./logffmpeg.txt --disable-shared --enable-parsers --disable-encoders --disable-debug --enable-decoders --disable-muxers --enable-demuxers --enable-static --disable-doc --enable-ffmpeg --enable-ffplay --enable-ffserver --enable-version3 --prefix=./dist-x64/ --enable-swscale --disable-yasm --disable-bzlib --enable-gpl --enable-nonfree --target-os=darwin --disable-mmx"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define FFMPEG_DATADIR "./dist-x64//share/ffmpeg"
#define AVCONV_DATADIR "./dist-x64//share/ffmpeg"
#define CC_IDENT "Apple LLVM version 5.0 (clang-500.2.76) (based on LLVM 3.3svn)"
